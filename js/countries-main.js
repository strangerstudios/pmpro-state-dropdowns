	...
	if (jQuery('#pmpro_scountry').length) {
		...
		if (typeof selected_states !== 'undefined' && jQuery(selected_states).length > 0) {
			if (jQuery("#pmpro_sstate").hasClass('pmpro_error')) {
				jQuery('#pmpro_sstate').replaceWith('<select id="pmpro_sstate" name="pmpro_sstate" class="pmpro_error"></select>');  //convert to dropdown so states can auto-populate   
			} else {
				jQuery('#pmpro_sstate').replaceWith('<select id="pmpro_sstate" name="pmpro_sstate" ></select>');  //convert to dropdown so states can auto-populate   
			}
			...
			if (jQuery("#pmpro_sstate").hasClass('pmpro_error')) {
				jQuery("#pmpro_sstate").replaceWith('<input type="text" id="pmpro_sstate" name="pmpro_sstate" class="pmpro_error" value="' + selected_state + '" />');
			} else {
				jQuery("#pmpro_sstate").replaceWith('<input type="text" id="pmpro_sstate" name="pmpro_sstate" value="' + selected_state + '" />');
			}
		}
